      ...
      <main>
        ...
        <section className="bg-slate-50 py-20 sm:py-24">
          <div className="section-shell grid items-center gap-14 lg:grid-cols-2">
            <div>
              <SectionHeading
                eyebrow="Every learner matters"
                title="Student Support"
                description="Students learn at different speeds and in different ways. Our teachers guide learners, communicate with families and provide support according to individual needs."
              />
            ...
            <motion.div
              ...
              className="rounded-[2.5rem] bg-royal-600 p-9 text-white shadow-2xl sm:p-12"
            >
              <Target
                size={45}
              ...
              <h3 className="mt-7 font-display text-3xl font-extrabold">
                Personal guidance for meaningful progress
              </h3>

              <p className="mt-5 leading-8 text-white/75">
                Academic support is intended to help every
                learner improve. Students who need additional
                assistance receive encouragement, while
                talented students are motivated to develop
                their abilities further.
              </p>

              <a
                href="/#contact"
                className="mt-8 inline-flex min-h-[52px] items-center justify-center gap-2 rounded-full bg-gold-400 px-7 font-extrabold text-navy-950 transition hover:-translate-y-1 hover:bg-white"
              >
