...
export const galleryItems = [
  ...
  },
  {
    ...
    category: 'Sports',
    description:
      'Students participate enthusiastically in races, games and physical activities during Annual Sports Day.',
    altText:
      'Students participating in a race during the annual school sports day',
    featured: true,
  },
  {
    id: 6,
    ...
    altText:
      'Students playing football during an inter-house sports competition',
    featured: false,
  },
  {
    id: 7,
    ...
    description:
      'Students celebrate Nepalese culture by presenting traditional dances in colourful cultural dress.',
    altText:
      'Students performing a traditional cultural dance on the school stage',
    featured: true,
  },
  {
    id: 8,
    ...
    category: 'Cultural Programs',
    description:
      'Young performers showcase their musical confidence and creativity during the school cultural program.',
    altText:
